...
function init() {
  ...
  //root.renderer.enableBackground()
...
function createTextAnimation() {
  var geometry = generateTextGeometry('TEAM FEED', {
    size:36,
    height:0,
    font:'droid sans',
      //droid sans
...
function TextAnimation(textGeometry) {
  ...
  this.animationDuration = maxDelayX + maxDelayY + maxDuration - 10;
  ...
  for (i = 0, i2 = 0, i3 = 0, i4 = 0; i < faceCount; i++, i2 += 6, i3 += 9, i4 += 12) {
    ...
    var delayY = Math.max(0, (3.0 - (centroid.y / size.height)) * maxDelayY);
  ...
  var material = new THREE.BAS.BasicAnimationMaterial({
      ...
      shaderVertexInit: [
        ...
        'float tProgress =  ease(tTime, 0.0, 1.75, tDuration);'
...
THREERoot.prototype = {
  ...
  resize: function() {
    this.camera.aspect = window.innerWidth / (window.innerHeight/2.75);
